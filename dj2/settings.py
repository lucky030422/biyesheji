...
STATIC_URL = '/assets/'
FRONT_STATIC_DIR = os.path.join(BASE_DIR, "templates/front/assets")
STATICFILES_DIRS = [FRONT_STATIC_DIR] if os.path.isdir(FRONT_STATIC_DIR) else []
...
ALIPAY_APP_ID = os.getenv('ALIPAY_APP_ID', '9021000127605975')
try:
    with open('{}/util/alipay_key/app_private_2048.txt'.format(BASE_DIR)) as key_file:
        APP_PRIVATE_KEY_STRING = key_file.read()
except FileNotFoundError:
    APP_PRIVATE_KEY_STRING = os.getenv('ALIPAY_APP_PRIVATE_KEY', '')
try:
    with open('{}/util/alipay_key/alipay_public_2048.txt'.format(BASE_DIR)) as key_file:
        ALIPAY_PUBLIC_KEY_STRING = key_file.read()
except FileNotFoundError:
