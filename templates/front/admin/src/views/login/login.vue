...
const defaultLoginBackground = getFilePath('upload/chongwufuwu_日常萌宠喂养遛护服务1.jpg')
...
<template>
  <div
    class="login"
    :style="{ '--login-bg': `url(${$projectImages.bLoginBackgroundImg || defaultLoginBackground})` }"
  >
    <section class="login-brand">
      <div class="brand-kicker">宠物店 Web 端入口</div>
      <h1>把寄养、服务、用品和领养集中到一个清爽入口</h1>
      <p>为宠物店线上业务提供统一登录体验，适合用户预约、浏览服务、购买用品以及查看宠物相关内容。</p>
      <div class="brand-tags">
        <div class="brand-tag">
          <strong>服务预约</strong>
          <span>洗护、喂养、上门照料入口统一。</span>
        </div>
        <div class="brand-tag">
          <strong>寄养管理</strong>
          <span>围绕档期、价格、状态快速进入。</span>
        </div>
        <div class="brand-tag">
          <strong>用品商城</strong>
          <span>商品购买、积分兑换保持一致体验。</span>
        </div>
      </div>
    </section>
