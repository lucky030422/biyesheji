...
const defaultLoginBackground = getFilePath('upload/jiyangfuwu_宠物度假寄养1.jpg')
...
<template>
  <div
    class="login"
    :style="{ '--login-bg': `url(${$projectImages.fLoginBackgroundImg || defaultLoginBackground})` }"
  >
    <section class="login-hero">
      <span class="hero-kicker">用户登录 · 宠物寄养预约平台</span>
      <h1>欢迎回到宠物寄养预约平台</h1>
      <div class="hero-metrics">
        <div class="hero-metric">
          <strong>预约寄养</strong>
          <span>查看档期、价格和寄养服务。</span>
        </div>
        <div class="hero-metric">
          <strong>宠物服务</strong>
          <span>洗护、喂养、上门照料快速进入。</span>
        </div>
        <div class="hero-metric">
          <strong>用品商城</strong>
          <span>登录后继续购买和收藏。</span>
        </div>
      </div>
    </section>
